...
echo ""
echo "Telemetry:"
echo "  Breadcrumb collects anonymous usage stats (install count, active"
echo "  users, command popularity). No personal data is collected."
echo "  To opt out:  echo '{\"telemetry\":false}' > ~/.breadcrumb/config.json"
echo "  Or set env:  export BREADCRUMB_TELEMETRY=false"
echo ""
