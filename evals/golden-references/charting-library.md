...
**Use when:** Displaying time-series data with one or more metrics.
```tsx
...
**Use when:** Showing proportional breakdowns of a whole.
```tsx
...
**Use when:** Your app supports light/dark mode toggling.
```tsx
